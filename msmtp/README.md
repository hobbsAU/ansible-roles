...
This ansible role deploys msmtp for Debian Linux
...
* Create and add git repo to your requirements.yml
* ansible galaxy ```ansible-galaxy install --roles-path=/your/role/path --role-file=requirements.yml --force```
